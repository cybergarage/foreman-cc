...
public:
    ...
    bool addDataPoints(std::time_t from, std::time_t interval, double* values, size_t valueCnt);
...
public:
    ...
    bool addDataPoints(const std::string& name, std::time_t from, std::time_t interval, double* values, size_t valueCnt);
